...
7. For developing 3rd party tools with its own server API endpoint or URL, see below. For testing a logged-in user in ProteinPaint-based tools,
   see `packages/portal-proto/src/features/proteinpaint/README.md`.
