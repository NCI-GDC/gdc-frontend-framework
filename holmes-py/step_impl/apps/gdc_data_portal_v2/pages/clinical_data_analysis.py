...
class ClinicalDataAnalysisLocators:
    ...
    BUTTON_CONTINUOUS_MODAL = lambda button_name: f"[data-testid='button-{button_name}']"
    BUTTON_SAVE_CANCEL_CONTINUOUS_MODAL = lambda button_name: f"[data-testid='button-custom-bins-{button_name}']"
    BUTTON_BIN_OPTION_CONTINUOUS_MODAL = lambda button_name: f"[data-testid='button-select-{button_name}']"

    TEXTBOX_SET_INTERVAL_SIZE_CONTINUOUS_MODAL = "[data-testid='textbox-set-interval-size']"
    TEXTBOX_SET_INTERVAL_MIN_CONTINUOUS_MODAL = "[data-testid='textbox-set-interval-min']"
    TEXTBOX_SET_INTERVAL_MAX_CONTINUOUS_MODAL = "[data-testid='textbox-set-interval-max']"

    TEXTBOX_SET_BIN_NAME_CONTINUOUS_MODAL = lambda row_number: f"[data-testid='textbox-range-name'] >> nth={row_number}"
    TEXTBOX_SET_RANGE_FROM_CONTINUOUS_MODAL = lambda row_number: f"[data-testid='textbox-range-from'] >> nth={row_number}"
    TEXTBOX_SET_RANGE_TO_CONTINUOUS_MODAL = lambda row_number: f"[data-testid='textbox-range-to'] >> nth={row_number}"
    BUTTON_ADD_CUSTOM_BIN_CONTINUOUS_MODAL = "[data-testid='button-range-add']"
    BUTTON_DELETE_CUSTOM_BIN_CONTINUOUS_MODAL = lambda row_number: f"[data-testid='button-range-delete'] >> nth={row_number}"
...
class ClinicalDataAnalysisPage(BasePage):
    ...
    def click_save_cancel_button_continuous_modal(self, button_name):
        ...
        button_name = self.normalize_button_identifier(button_name)
        button_locator = ClinicalDataAnalysisLocators.BUTTON_SAVE_CANCEL_CONTINUOUS_MODAL(button_name)
        self.click(button_locator)

    def click_button_continuous_modal(self, button_name):
        """Clicks specified button in a continuous value modal"""
        button_name = self.normalize_button_identifier(button_name)
        button_locator = ClinicalDataAnalysisLocators.BUTTON_CONTINUOUS_MODAL(button_name)
        self.click(button_locator)

    def click_button_bin_option_continuous_modal(self, button_name):
        """Choose between set interval or custom range option"""
        button_name = self.normalize_button_identifier(button_name)
        button_locator = ClinicalDataAnalysisLocators.BUTTON_BIN_OPTION_CONTINUOUS_MODAL(button_name)
        self.click(button_locator)

    def set_interval_with_min_to_max_continuous_modal(self, interval_amount, min_value, max_value):
        """In the set interval option, set a custom interval with a min and max"""
        interval_size_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_INTERVAL_SIZE_CONTINUOUS_MODAL
        interval_min_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_INTERVAL_MIN_CONTINUOUS_MODAL
        interval_max_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_INTERVAL_MAX_CONTINUOUS_MODAL
    ...
    def add_or_edit_custom_range_continuous_modal(self, bin_name, from_value, to_less_than_value, row_number):
        ...
        bin_name_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_BIN_NAME_CONTINUOUS_MODAL(row_number)
        range_from_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_RANGE_FROM_CONTINUOUS_MODAL(row_number)
        range_to_locator = ClinicalDataAnalysisLocators.TEXTBOX_SET_RANGE_TO_CONTINUOUS_MODAL(row_number)
    ...
    def click_add_custom_bin_button_continuous_modal(self):
        ...
        add_custom_bin_button_locator = ClinicalDataAnalysisLocators.BUTTON_ADD_CUSTOM_BIN_CONTINUOUS_MODAL
    ...
    def click_delete_custom_bin_button_continuous_modal(self, row_number):
        ...
        row_number = self.make_input_0_index(row_number)
        delete_custom_bin_button_locator = ClinicalDataAnalysisLocators.BUTTON_DELETE_CUSTOM_BIN_CONTINUOUS_MODAL(row_number)
