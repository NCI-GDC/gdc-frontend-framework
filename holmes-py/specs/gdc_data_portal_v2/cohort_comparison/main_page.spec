...
* Verify "Sex at Birth_female_CC_Compare_1 Count" and "CC_Sex At Birth_Female_1 Count" are "Equal"
...
* Verify "Sex at Birth_male_CC_Compare_2 Count" and "CC_Sex At Birth_Male_2 Count" are "Equal"
...
* Switch cohort to "CC_Sex At Birth_Missing_2" from the Cohort Bar dropdown list
* Collect Cohort Bar Case Count for comparison
* Verify "Cohort Bar Case Count" and "CC_Sex At Birth_Missing_2 Count" are "Equal"
