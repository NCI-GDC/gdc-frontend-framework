...
* Download "File" from "Case Summary Files Table File"
* Read metadata from compressed "File from Case Summary Files Table File"
* Verify that "File from Case Summary Files Table File" has expected information
  |required_info                          |
  |---------------------------------------|
