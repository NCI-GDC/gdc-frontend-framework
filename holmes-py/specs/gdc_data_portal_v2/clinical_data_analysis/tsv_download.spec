...
* Collect analysis card table data for comparison on the Clinical Data Analysis page
  |button_label                         |analysis_card|row  |column |
  |-------------------------------------|-------------|-----|-------|
  |Gender_R1_C2                         |Gender       |1    |2      |
  |Gender_R1_C3                         |Gender       |1    |3      |
  |Gender_R2_C2                         |Gender       |2    |2      |
  |Gender_R2_C3                         |Gender       |2    |3      |
  |Gender_R3_C2                         |Gender       |3    |2      |
  |Gender_R3_C3                         |Gender       |3    |3      |
  |Gender_R4_C2                         |Gender       |4    |2      |
  |Gender_R4_C3                         |Gender       |4    |3      |
  |Gender_R5_C2                         |Gender       |5    |2      |
  |Gender_R5_C3                         |Gender       |5    |3      |
...
* Collect analysis card table data for comparison on the Clinical Data Analysis page
  |button_label                         |analysis_card    |row  |column |
  |-------------------------------------|-----------------|-----|-------|
  |Age At Diagnosis_R1_C2               |Age At Diagnosis |1    |2      |
  |Age At Diagnosis_R1_C3               |Age At Diagnosis |1    |3      |
  |Age At Diagnosis_R2_C2               |Age At Diagnosis |2    |2      |
  |Age At Diagnosis_R2_C3               |Age At Diagnosis |2    |3      |
  |Age At Diagnosis_R3_C2               |Age At Diagnosis |3    |2      |
  |Age At Diagnosis_R3_C3               |Age At Diagnosis |3    |3      |
  |Age At Diagnosis_R4_C2               |Age At Diagnosis |4    |2      |
  |Age At Diagnosis_R4_C3               |Age At Diagnosis |4    |3      |
  |Age At Diagnosis_R5_C2               |Age At Diagnosis |5    |2      |
  |Age At Diagnosis_R5_C3               |Age At Diagnosis |5    |3      |
...
* Collect analysis card table data for comparison on the Clinical Data Analysis page
  |button_label                         |analysis_card    |row  |column |
  |-------------------------------------|-----------------|-----|-------|
  |Primary Diagnosis_R1_C3              |Primary Diagnosis|1    |3      |
  |Primary Diagnosis_R1_C4              |Primary Diagnosis|1    |4      |
  |Primary Diagnosis_R2_C3              |Primary Diagnosis|2    |3      |
  |Primary Diagnosis_R2_C4              |Primary Diagnosis|2    |4      |
  |Primary Diagnosis_R3_C3              |Primary Diagnosis|3    |3      |
  |Primary Diagnosis_R3_C4              |Primary Diagnosis|3    |4      |
  |Primary Diagnosis_R4_C3              |Primary Diagnosis|4    |3      |
  |Primary Diagnosis_R4_C4              |Primary Diagnosis|4    |4      |
  |Primary Diagnosis_R5_C3              |Primary Diagnosis|5    |3      |
  |Primary Diagnosis_R5_C4              |Primary Diagnosis|5    |4      |
  |Primary Diagnosis_R22_C3             |Primary Diagnosis|22   |3      |
  |Primary Diagnosis_R22_C4             |Primary Diagnosis|22   |4      |
...
* Collect analysis card table data for comparison on the Clinical Data Analysis page
  |button_label                         |analysis_card    |row  |column |
  |-------------------------------------|-----------------|-----|-------|
  |Age At Diagnosis_R1_C1               |Age At Diagnosis |1    |1      |
  |Age At Diagnosis_R1_C2               |Age At Diagnosis |1    |2      |
  |Age At Diagnosis_R2_C1               |Age At Diagnosis |2    |1      |
  |Age At Diagnosis_R2_C2               |Age At Diagnosis |2    |2      |
  |Age At Diagnosis_R3_C1               |Age At Diagnosis |3    |1      |
  |Age At Diagnosis_R3_C2               |Age At Diagnosis |3    |2      |
  |Age At Diagnosis_R4_C1               |Age At Diagnosis |4    |1      |
  |Age At Diagnosis_R4_C2               |Age At Diagnosis |4    |2      |
  |Age At Diagnosis_R5_C1               |Age At Diagnosis |5    |1      |
  |Age At Diagnosis_R5_C2               |Age At Diagnosis |5    |2      |
* Read from "Age At Diagnosis from CDAVE Analysis Card TSV"
* Verify that "Age At Diagnosis from CDAVE Analysis Card TSV" has expected information
  |required_info                          |
