      ...
      <div className="flex flex-row items-center justify-end w-full p-2">
        <div className="bg-none flex items-center ">
          <div className="relative w-full ">
            ...
            <input
              type="text"
              className="h-10 pr-8 w-full pl-5  shadow-md  border-nci-gray-light rounded-sm focus:ring-nci-cyan-light focus:border-nci-teal-light hover:shadow-lg hover:border-nci-teal-lighter"
              placeholder={`Search ...`}
              value={searchTerm}
