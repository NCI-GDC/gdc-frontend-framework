...
const MutationTable: React.FC<unknown> = () => {
  ...
  return (
    <div className="flex flex-col w-100">
      <VerticalTable tableData={getTableFormatData(data)} tableFunc={tableFunc} customCellKeys={["impact", "survival"]} customGridMapping={getCustomGridCell} selectableRow={true}></VerticalTable>
