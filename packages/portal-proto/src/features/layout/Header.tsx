  ...
  return (
    <div className="px-4 py-3 border-b border-gdc-grey-lightest flex flex-col">
      ...
      <div className="flex flex-row justify-between">
        ...
        <div className="flex justify-end sm:flex-wrap lg:flex-nowrap md:mb-3 lg:mb-0 md:gap-0 lg:gap-3 items-center text-primary-darkest font-heading text-sm font-medium">
          <a
