        ...
        {(state) => (
          <div
            className={
              {
                entering:
                  "animate-slide-up min-h-[550px] w-full flex flex-col absolute z-[1000]",
                entered: "min-h-[550px] w-full flex flex-col absolute z-[1000]",
                exiting:
                  "animate-slide-down min-h-[550px] w-full flex flex-col absolute z-[1000]",
