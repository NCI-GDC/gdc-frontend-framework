...
interface DownloadButtonTotalProps {
...
const DownloadButtonTotal: React.FC<DownloadButtonTotalProps> = ({
  createSetHook,
  entityType,
  filters,
  setKey,
  disabled,
}: DownloadButtonTotalProps) => {
...
export default DownloadButtonTotal;
