  ...
  test("test to build positive days range", () => {
    const expectedBucketRanges = {
      ...
      "21915.0-25568.0": {
        from: 21915,
        key: "21915.0-25568.0",
        label: "≥ 21,915 to < 25,568 days",
        to: 25568,
      },
      "25568.0-29220.0": {
        from: 25568,
        key: "25568.0-29220.0",
        label: "≥ 25,568 to < 29,220 days",
        to: 29220,
      },
      "29220.0-32873.0": {
        from: 29220,
        key: "29220.0-32873.0",
        label: "≥ 29,220 to < 32,873 days",
        to: 32873,
      },
      "32873.0-36525.0": {
        from: 32873,
        key: "32873.0-36525.0",
        label: "≥ 32,873 to < 36,525 days",
        to: 36525,
      },
      "3653.0-7305.0": {
        from: 3653,
  ...
  test("test to build -90/90 years range", () => {
    const expectedBucketRanges = {
      "-10958.0--7305.0": {
        from: -10958,
        key: "-10958.0--7305.0",
        label: "≥ -10,958 to < -7,305 days",
        to: -7305,
      },
      "-14610.0--10958.0": {
        from: -14610,
        key: "-14610.0--10958.0",
        label: "≥ -14,610 to < -10,958 days",
        to: -10958,
      },
      "-18263.0--14610.0": {
        from: -18263,
        key: "-18263.0--14610.0",
        label: "≥ -18,263 to < -14,610 days",
        to: -14610,
      },
      "-21915.0--18263.0": {
        from: -21915,
        key: "-21915.0--18263.0",
        label: "≥ -21,915 to < -18,263 days",
        to: -18263,
      },
      "-25568.0--21915.0": {
        from: -25568,
        key: "-25568.0--21915.0",
        label: "≥ -25,568 to < -21,915 days",
        to: -21915,
      },
      "-29220.0--25568.0": {
        from: -29220,
        key: "-29220.0--25568.0",
        label: "≥ -29,220 to < -25,568 days",
        to: -25568,
      },
      "-32873.0--29220.0": {
        from: -32873,
        key: "-32873.0--29220.0",
        label: "≥ -32,873 to < -29,220 days",
        to: -29220,
      },
      "-3653.0-0.0": {
        from: -3653,
        key: "-3653.0-0.0",
        label: "≥ -3,653 to < 0 days",
        to: 0,
      },
      "-7305.0--3653.0": {
        from: -7305,
        key: "-7305.0--3653.0",
        label: "≥ -7,305 to < -3,653 days",
        to: -3653,
      },
      "0.0-3653.0": {
        from: 0,
