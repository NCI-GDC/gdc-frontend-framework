[@gff/core](../README.md) / [Exports](../modules.md) / GDCGenesTable

# Interface: GDCGenesTable

## Table of contents

### Properties

- [cases](GDCGenesTable.md#cases)
- [cnvCases](GDCGenesTable.md#cnvcases)
- [filteredCases](GDCGenesTable.md#filteredcases)
- [genes](GDCGenesTable.md#genes)
- [genes\_total](GDCGenesTable.md#genes_total)
- [mutationCounts](GDCGenesTable.md#mutationcounts)
...
• `Readonly` **genes**: readonly [`GeneRowInfo`](GeneRowInfo.md)[]
...
• `Optional` `Readonly` **mutationCounts**: `Record`<`string`, `string`\>
