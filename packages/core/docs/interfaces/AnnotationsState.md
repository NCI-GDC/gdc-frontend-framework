[@gff/core](../README.md) / [Exports](../modules.md) / AnnotationsState
...
- [annotations](AnnotationsState.md#annotations)
- [error](AnnotationsState.md#error)
- [status](AnnotationsState.md#status)

## Properties

### annotations

• `Readonly` **annotations**: `Record`<`string`, [`Annotation`](Annotation.md)\>
