[@gff/core](../README.md) / [Exports](../modules.md) / AppDataSelectorResponse

# Interface: AppDataSelectorResponse<T\>
...
- [data](AppDataSelectorResponse.md#data)
- [error](AppDataSelectorResponse.md#error)
- [status](AppDataSelectorResponse.md#status)
