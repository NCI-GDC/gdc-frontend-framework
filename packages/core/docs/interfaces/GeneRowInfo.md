[@gff/core](../README.md) / [Exports](../modules.md) / GeneRowInfo

# Interface: GeneRowInfo

## Table of contents

### Properties

- [biotype](GeneRowInfo.md#biotype)
- [case\_cnv\_gain](GeneRowInfo.md#case_cnv_gain)
- [case\_cnv\_loss](GeneRowInfo.md#case_cnv_loss)
- [cnv\_case](GeneRowInfo.md#cnv_case)
- [cytoband](GeneRowInfo.md#cytoband)
- [gene\_id](GeneRowInfo.md#gene_id)
- [id](GeneRowInfo.md#id)
- [is\_cancer\_gene\_census](GeneRowInfo.md#is_cancer_gene_census)
- [name](GeneRowInfo.md#name)
- [numCases](GeneRowInfo.md#numcases)
- [ssm\_case](GeneRowInfo.md#ssm_case)
- [symbol](GeneRowInfo.md#symbol)
...
• `Readonly` **case\_cnv\_gain**: `number`
...
• `Readonly` **case\_cnv\_loss**: `number`
...
• `Readonly` **cytoband**: readonly `string`[]
...
### is\_cancer\_gene\_census

• `Readonly` **is\_cancer\_gene\_census**: `boolean`
