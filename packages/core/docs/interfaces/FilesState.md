[@gff/core](../README.md) / [Exports](../modules.md) / FilesState
...
- [error](FilesState.md#error)
- [files](FilesState.md#files)
- [status](FilesState.md#status)
...
• `Optional` `Readonly` **files**: readonly [`GdcFile`](GdcFile.md)[]
