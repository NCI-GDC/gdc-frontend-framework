[@gff/core](../README.md) / [Exports](../modules.md) / GdcAppMetadata

# Interface: GdcAppMetadata

## Table of contents

### Properties

- [id](GdcAppMetadata.md#id)
- [name](GdcAppMetadata.md#name)
- [requiredEntityTypes](GdcAppMetadata.md#requiredentitytypes)
- [version](GdcAppMetadata.md#version)
