[@gff/core](../README.md) / [Exports](../modules.md) / FacetsState
...
- [cases](FacetsState.md#cases)
- [files](FacetsState.md#files)

## Properties

### cases

• `Readonly` **cases**: `Record`<`string`, [`FacetBuckets`](FacetBuckets.md)\>
...
• `Readonly` **files**: `Record`<`string`, [`FacetBuckets`](FacetBuckets.md)\>
