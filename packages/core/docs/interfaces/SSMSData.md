[@gff/core](../README.md) / [Exports](../modules.md) / SSMSData
...
- [consequence](SSMSData.md#consequence)
- [filteredOccurrences](SSMSData.md#filteredoccurrences)
- [genomic\_dna\_change](SSMSData.md#genomic_dna_change)
- [id](SSMSData.md#id)
- [mutation\_subtype](SSMSData.md#mutation_subtype)
- [occurrence](SSMSData.md#occurrence)
- [score](SSMSData.md#score)
- [ssm\_id](SSMSData.md#ssm_id)

## Properties

### consequence

• `Readonly` **consequence**: readonly [`SSMSConsequence`](SSMSConsequence.md)[]
...
### genomic\_dna\_change

• `Readonly` **genomic\_dna\_change**: `string`
...
• `Readonly` **mutation\_subtype**: `string`
