[@gff/core](../README.md) / [Exports](../modules.md) / GraphQLFetchError
...
- [status](GraphQLFetchError.md#status)
- [statusText](GraphQLFetchError.md#statustext)
- [text](GraphQLFetchError.md#text)
- [url](GraphQLFetchError.md#url)
- [variables](GraphQLFetchError.md#variables)
...
• `Optional` `Readonly` **variables**: `Record`<`string`, `any`\>
