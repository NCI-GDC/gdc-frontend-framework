[@gff/core](../README.md) / [Exports](../modules.md) / SsmPlotState

# Interface: SsmPlotState

## Table of contents

### Properties

- [error](SsmPlotState.md#error)
- [ssm](SsmPlotState.md#ssm)
- [status](SsmPlotState.md#status)
...
• `Readonly` **ssm**: [`SsmPlotData`](SsmPlotData.md)
