...
describe("continuous range slice tests", () => {
  ...
  test("fetch without overriding filters", async () => {
    ...
    expect(spyFetch).toBeCalledWith(
      ...
      {
        body: '{"query":"\\n  query ContinuousAggregationQuery($filters: FiltersArgument, $filters2: FiltersArgument) {\\n  viewer {\\n    explore {\\n      cases {\\n        aggregations(filters: $filters) {\\n          diagnoses__age_at_diagnosis : diagnoses__age_at_diagnosis {\\n           stats {\\n                Min : min\\n                Max: max\\n                Mean: avg\\n                SD: std_deviation\\n                count\\n            }\\n            range(ranges: $filters2) {\\n              buckets {\\n                doc_count\\n                key\\n              }\\n            }\\n          }\\n        }\\n      }\\n    }\\n  }\\n}\\n","variables":{"filters":{"op":"and","content":[{"op":"in","content":{"field":"cases.demographic.gender","value":["female"]}}]},"filters2":{"op":"range","content":[{"ranges":[{"from":0,"to":6574.4},{"from":6574.4,"to":13148.8},{"from":13148.8,"to":19723.199999999997},{"from":19723.199999999997,"to":26297.6},{"from":26297.6,"to":32873}]}]}}}',
        headers: {
  ...
  test("fetch with overriding filters", async () => {
    ...
    expect(spyFetch).toBeCalledWith(
      "https://portal.gdc.cancer.gov/auth/api/v0/graphql",
      {
        body: '{"query":"\\n  query ContinuousAggregationQuery($filters: FiltersArgument, $filters2: FiltersArgument) {\\n  viewer {\\n    explore {\\n      cases {\\n        aggregations(filters: $filters) {\\n          diagnoses__age_at_diagnosis : diagnoses__age_at_diagnosis {\\n           stats {\\n                Min : min\\n                Max: max\\n                Mean: avg\\n                SD: std_deviation\\n                count\\n            }\\n            range(ranges: $filters2) {\\n              buckets {\\n                doc_count\\n                key\\n              }\\n            }\\n          }\\n        }\\n      }\\n    }\\n  }\\n}\\n","variables":{"filters":{"op":"and","content":[{"op":"in","content":{"field":"cases.project.project_id","value":["TCGA-LGG"]}}]},"filters2":{"op":"range","content":[{"ranges":[{"from":0,"to":6574.4},{"from":6574.4,"to":13148.8},{"from":13148.8,"to":19723.199999999997},{"from":19723.199999999997,"to":26297.6},{"from":26297.6,"to":32873}]}]}}}',
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
        },
