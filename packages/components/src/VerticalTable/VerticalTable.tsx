...
export interface Columns extends ColumnItem {
  /**
...
interface VerticalTableProps {
   ...
   */
  handleChange?: (arg0: HandleChangeInput) => void;
  /**
...
export const filterColumnCells = (newList: Columns[]): Column[] => {
  return newList.reduce((filtered: Column[], obj) => {
    if (obj.visible) {
...
export const VerticalTable: FC<VerticalTableProps> = ({
  ...
  const [table, setTable] = useState([] as TableData);
